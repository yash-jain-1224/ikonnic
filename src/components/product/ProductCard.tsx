  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-rosegold-200/60 bg-white shadow-card transition duration-300 hover:-translate-y-1 hover:shadow-soft">
      ...
      <div className="p-3">
        ...
        <Link href={`/customise/${product.slug}`} className="mt-3 inline-flex items-center gap-1 rounded-full bg-rosegold-50 px-3 py-1.5 text-[10px] font-black tracking-wide text-ikonnic-red transition hover:bg-ikonnic-red hover:text-white">
